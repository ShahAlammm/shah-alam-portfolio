        ...
        <div className="navbar fixed z-[900] px-12">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <li><Link href={'https://github.com/ShahAlammm'}><FaGithub className="text-xl" /></Link></li>
                    </ul>
                </div>
            ...
            <div className="navbar-center hidden md:flex justify-center items-center glass rounded-full lg:w-1/4 button-primary">
                <ul className="menu menu-horizontal px-1 space-x-4 font-bold text-white">
                    <li><Link href={'/'}><FaHome className="text-2xl" /></Link></li>
                    <li><Link href={'#'}><FaUserGraduate className="text-2xl" /></Link></li>
                    <li><Link href={'https://github.com/ShahAlammm'}><FaGithub className="text-2xl" /></Link></li>
                </ul>
            </div>
            <div className="navbar-end">
                {socials?.map((social: any) => (<Link key={social._id} href={social.url} ><Image src={social.image.url} alt={social.platform} height={500} width={500} className='h-7 w-7 md:h-12 md:w-12 p-[2px] md:p-2 transform hover:scale-125 transition-transform duration-300' /></Link>))}
            </div>
        </div>
    );
};
